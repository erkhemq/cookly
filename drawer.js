...
export class Drawer extends HTMLElement {
  ...
  createDetailWrapper(id, name, count, ingredients) {
    const section = this.shadowRoot.querySelector(".detail-wrapper");
    if (section) {
      ...
      heartImg.src = getLikedFoods()[id]
        ? "./assets/filled-heart.svg"
        : "./assets/heart.svg"; // Load liked state
      heartImg.width = 14;
      heartImg.alt = "heart";
